...
#   timestamp: 2025-06-23T07:09:39+00:00
...
class InlineValue(
    RootModel[Union[bool, bytes, str, int, float, list, dict[str, Any], Bbox]]
):
    root: Union[bool, bytes, str, int, float, list, dict[str, Any], Bbox]
...
class ProcessResults(RootModel[Optional[dict[str, InlineOrRefValue]]]):
