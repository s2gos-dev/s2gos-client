...
#   timestamp: 2025-06-06T07:45:18+00:00
...
class InputValueNoObject(
    RootModel[Union[str, float, int, bool, List[str], BinaryInputValue, Bbox]]
):
    root: Union[str, float, int, bool, List[str], BinaryInputValue, Bbox]
...
class Schema(RootModel[Union[Reference, Schema1]]):
