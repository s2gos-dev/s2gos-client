...
#   filename:  api.py:
#   timestamp: 2025-06-04T15:53:53.015319
...
def get_landing_page(_service: Optional[Service] = None) -> LandingPage:
    ...
    return (_service or Service.default()).call(
        path="/", method="get", params={}, return_type=LandingPage
    )
...
def get_processes(_service: Optional[Service] = None) -> ProcessList:
    ...
    """
    return (_service or Service.default()).call(
        path="/processes", method="get", params={}, return_type=ProcessList
    )
...
def get_jobs(_service: Optional[Service] = None) -> JobList:
    ...
    """
    return (_service or Service.default()).call(
        path="/jobs", method="get", params={}, return_type=JobList
    )


def execute(process_id: str, _service: Optional[Service] = None) -> Any:
    """
    Create a new job.
