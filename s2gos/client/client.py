...
#   filename:  client.py:
#   timestamp: 2025-06-23T09:09:52.517880
...
class Client:
    ...
    def _repr_json_(self):
        ...
        return self._transport.config._repr_json_()

    def get_landing_page(self) -> Capabilities:
        """
    ...
    def get_conformance_classes(self) -> ConformanceDeclaration:
        """
    ...
    def execute(self, process_id: str, request: ProcessRequest) -> JobInfo:
        """
        Create a new job.
    ...
    def dismiss(self, job_id: str) -> JobInfo:
        """
    ...
    def get_result(self, job_id: str) -> ProcessResults:
        """
        ...
        Returns:
          ProcessResults: The results of a job.
        ...
        return self._transport.call(
            ...
            query_params={},
            request=None,
            return_types={"200": ProcessResults},
            error_types={"404": ApiError, "500": ApiError},
        )
